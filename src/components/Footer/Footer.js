...
const Footer = () => {
    ...
    return (
      <div className="bg-tertiary text-primary p-8">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">

          {/* Columna 1: Logo y frase */}
          <div className="flex flex-col items-center md:items-start">
            <Image src={logo} alt="Logo Farmacia" width={100} height={100} />
            <p className="mt-4 text-center md:text-left">Frase acerca de tu farmacia.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/politicas" className="hover:text-C8D403">Políticas</a></li>
              <li><a href="/faq" className="hover:text-C8D403">Preguntas Frecuentes</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/blog-salud" className="hover:text-C8D403">Blog de Salud</a></li>
              <li><a href="/marcas" className="hover:text-C8D403">Marcas con las que trabajamos</a></li>
            </ul>
          </div>
          <div className="bg-primary bgmd:mt-0 md:col-span-3 flex justify-between items-center p-2">
            <p className="text-tertiary ">&copy; {new Date().getFullYear()} Pharmahogar. Todos los derechos reservados.</p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
                <img src="https://d2fji7bh9tddzf.cloudfront.net/wp-content/uploads/ic_facebook_footer.png" alt="Facebook" width="24" height="24" />
              </a>

              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
                <img src="https://d2fji7bh9tddzf.cloudfront.net/wp-content/uploads/ic_instagram.png" alt="Instagram" width="24" height="24" />
              </a>
